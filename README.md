...
현재도 직접 사용 중이며, 공고 수집과 검색, 즐겨찾기, 마감 처리, 알림, 실행 로그 확인까지 한 흐름으로 묶었습니다.
...
청약 공고를 직접 확인하면서 새 공고, 마감일, 발표일을 따로 챙겨야 했습니다. 놓치는 경우도 있었고 같은 내용을 반복해서 확인하는 시간이 컸습니다.

그래서 공공 API에서 공고를 수집하고 DB에 저장한 뒤, 화면에서는 검색과 상세 확인에 집중하도록 구성했습니다. 즐겨찾기한 공고는 알림 대상과 연결하고, 종료일이 지난 공고는 자동으로 상태를 갱신합니다.

이 서비스로 실제 공고를 확인하고 관리했고, 현재 거주 중인 집을 구할 때도 사용했습니다.
