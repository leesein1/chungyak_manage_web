...
- [v] 대시보드 핵심 기능(캘린더/지도 모드, D-7·즐겨찾기 연계) 구현 완료 (2026-04-13)
- [v] 조회 화면 연동 1·2차(목록/상세/API/즐겨찾기/상세지도) 구현 완료 (2026-04-13)
- [v] UTF-8 인코딩 통일 작업 반영 (2026-04-13)
- [ ] 지역 확장(서울 / 경기 등)
- [v] 웹 대시보드 제공 -> 최종 완료 (2026-04-13)
- [ ] 모바일 알림(FCM)
