...
공고 수집과 검색, 즐겨찾기, 마감 처리, 알림, 실행 로그 확인까지 한 흐름으로 묶었습니다. 현재도 직접 사용 중이며, 이 서비스를 통해 실제로 지금 살고 있는 행복주택을 구했습니다.
...
결혼 준비를 하면서 청약·임대 공고를 직접 확인하고 관리했습니다. 새 공고, 마감일, 발표일을 따로 챙겨야 했고 같은 내용을 반복해서 확인하는 경우도 많았습니다.

공공 API에서 공고를 수집해 DB에 저장하고, 화면에서는 검색과 상세 확인에 집중하도록 구성했습니다. 즐겨찾기한 공고는 알림 대상과 연결하고 종료일이 지난 공고는 자동으로 상태를 갱신합니다.

단순히 만들어본 서비스가 아니라 실제 집을 구하는 데 사용했습니다. 공고를 확인하고 관리하는 과정에서 이 서비스를 계속 사용했고, 최종적으로 현재 거주 중인 행복주택을 구했습니다.
